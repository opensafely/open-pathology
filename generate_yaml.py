...
yaml_template = """
  ...
  generate_processed_data_{test}_tests:
    ...
    outputs:
      moderately_sensitive:
        monthly_tables: output/{test}_tests/*table_counts_per_month*.csv
        expanded_deciles: output/{test}_tests/*expanded_deciles_table*.csv
  ...
  generate_processed_data_{test}_tests_light:
    ...
    outputs:
      moderately_sensitive:
        monthly_tables: output/{test}_tests/*per_month_light.csv
